...
public class Watek_TOPIC extends AbstractWatek {
    ...
    public List<TypT> NAD_TEMATY = of(TypT.WYGLAD, TypT.CZAS, TypT.MIEJSCE, TypT.EMOCJE_UCZUCIA, TypT.RZECZY_POWIAZANE, TypT.OSOBY_POWIAZANE,
            TypT.PREFERENCJE, TypT.ZMYSLY,
