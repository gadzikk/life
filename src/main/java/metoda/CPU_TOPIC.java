...
public class CPU_TOPIC extends AbstractCPU {
    ...
    public List<TypT> UTRZYMYWACZE = of(TypT.PRZEWIDZENIE, TypT.WNIOSKI, TypT.DEEP, TypT.KONTRA, TypT.COMPARE, TypT.ZART, TypT.POTWIERDZENIE, TypT.JAKI_JAKA_JAKIE);

    public List<TypT> NAD_TEMATY = of(TypT.WYGLAD, TypT.CZAS_MIEJSCE, TypT.EMOCJE_UCZUCIA, TypT.OSOBY_POWIAZANE, TypT.ZMYSLY,
